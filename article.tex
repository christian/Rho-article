...
\newcommand\myauthor{Cristian Prodan and Prof. Dr. Horia F. Pop}
\newcommand\mytitle{Design of a Recommender System using Collaborative Filtering}

% \usepackage[plainpages=false, pdfpagelabels, bookmarksnumbered, backref, pdftitle={\mytitle}, pagebackref, pdfauthor={\myauthor}, dvipdfmx, colorlinks=true, citecolor=gray, linkcolor=gray, urlcolor=gray]{hyperref}
